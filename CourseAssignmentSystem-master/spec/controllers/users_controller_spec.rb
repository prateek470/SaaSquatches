...
RSpec.describe UsersController, type: :controller do
   ...
   describe 'creating new user' do
	...
	it 'should redirect to sign_up if information is not given' do
	post :create, {:user => {:id => 6, :faculty_name=> "Davis Tim",:faculty_id=>"9"}}
	response.should redirect_to signup_path
	end
	
    it 'should have the user in the session hash' do
    post :create, {:user => {:id => "1", :faculty_name=> "Keyser John",:faculty_id=>"25", :email => "john@tamu.edu", :password => "password"}}
